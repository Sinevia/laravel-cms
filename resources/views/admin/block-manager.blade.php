...
<ol class="breadcrumb">
    ...
    <li><a href="<?php echo \Sinevia\Cms\Helpers\Links::adminBlockManager(); ?>">Blocks</a></li>
    <li class="active"><a href="<?php echo \Sinevia\Cms\Helpers\Links::adminBlockManager(); ?>">Blocks</a></li>
</ol>
@stop
